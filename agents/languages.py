...
LANGUAGE_CONFIG = {
    ...
    "hi": {
        ...
        "stt_language": "hi",
        "greeting": "नमस्ते, मैं प्रिया Fairvalue Insuretech प्राइवेट लिमिटेड की तरफ से आपकी इंश्योरेंस पॉलिसी रिन्यूअल के बारे में बात कर रही हूँ। क्या मेरी बात {name} जी से हो रही है?",
